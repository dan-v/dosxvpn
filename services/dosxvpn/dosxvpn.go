...
func (s Service) UserData() string {
    ...
    - name: dosxvpn.service
      ...
      content: |
        ...
        ExecStart=/usr/bin/docker run --name dosxvpn --privileged --net=host -v dosxvpn-ipsec.d:/etc/ipsec.d -v strongswan.d:/etc/strongswan.d -v /lib/modules:/lib/modules -v /etc/localtime:/etc/localtime -e VPN_DOMAIN=$public_ipv4 dosxvpn/strongswan:latest
